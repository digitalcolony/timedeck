				...
				>
					<div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
						<Container size="xl" py="xl">
								...
								{cities.length > 0 && (
									<ActionIcon
										...
										style={{
											...
											border: colorScheme === "dark" ? "1px solid #4b5563" : "1px solid #d1d5db",
							...
							<Text ta="center" c="dimmed" mb="xl" size="lg" style={{ fontWeight: 500 }}>
								Your global time dashboard • Track multiple cities • Bookmark this page
							</Text>
							...
							{/* Error display */}
							{error && (
								<Alert icon={<IconInfoCircle size={16} />} title="Notice" color="red" mb="lg">
									{error}
								</Alert>
							)}

							{/* City selector */}
							<CitySelector onCitySelect={handleCitySelect} selectedCityIds={selectedCityIds} />
